...
VP_Security::instance()->whitelist_function('vp_dep_is_audio');

function vp_dep_is_audio($value)
{
	if($value === 'audio')
		return true;
	return false;
...
VP_Security::instance()->whitelist_function('vp_dep_is_video');

function vp_dep_is_video($value)
{
	if($value === 'video')
		return true;
	return false;
