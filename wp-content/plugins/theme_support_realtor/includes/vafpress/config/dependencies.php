...
return array(
	 ...
	 */
	'scripts' => array(
		'always' => array('jquery', 'scrollspy', 'tipsy', 'jquery-typing', 'select2'),
		'paths' => array(
			'jquery' => array(
	...
	'styles' => array(
		'always' => array('tipsy', 'font-awesome', 'font-awesome-new', 'font-awesome-ie7', 'select2'),
		'paths' => array(
			'bootstrap-colorpicker' => array(
			...
			'font-awesome-new' => array(
				'path' => get_template_directory_uri() . '/css/font-awesome.css',
				'deps' => array(),
			),
			'select2' => array(
