;(function($) {
	...
	$(document).on('ready', function(){
		$.each($('.vp-wrap .vp-field'), function(index, elem){
			if(jQuery(this).parents('.tocopy').length <= 0){
	...
	$('.vp-js-option-form').bind('submit', function(e) {
		...
		var $loading = $('.vp-js-save-loader'),
			...
			data = 'action=vp_ajax_' + vp_opt.name + '_save&'+option+'&nonce='+vp_opt.nonce;
			/*data = {
...
/*jQuery(document).ready(function($) {
    $('.sh_demo_settings_import').live('click',function(e){
		e.preventDefault();
		if( !confirm( 'Are you really want to install demo settings' ) ) {
			return false;
		}else{
...
(function($) {
    "use strict";
        $('.sh_demo_settings_import').click(function(){
        ...
        var data = {
            'action': '_data_import_hook'       
        };
		
		$(this).attr( 'disabled', 'disabled' );
		
		$('.vp-field-loader.vp-js-loader.vp-dummy-load').css( 'display', 'inline' );
       ...
       // since 2.8 ajaxurl is always defined in the admin header and points to admin-ajax.php
        $.post(ajaxurl, data, function(response) {
			...
			$('.vp-field-loader.vp-js-loader').css( 'display', 'none' );
			$('.sh_demo_settings_import').removeAttr('disabled');
        });
