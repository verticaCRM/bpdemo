;(function($) {
	...
	function vp_init_fields($elements, newcopy)
	{
		if( adminpage === 'post-new-php' || adminpage === 'post-php' || newcopy === true )
		{
	...
	$(document).ready(function () {
		vp_init_fields(jQuery('.vp-metabox .vp-field'), false);
	...
	$.wpalchemy.on('wpa_copy', function(event, clone){
		...
		vp_init_fields(clone.find('.vp-field'), true);
