...
//Services
vc_map( array(
			"name" => __("bbPress Forums", SH_NAME),
...
class WPBakeryShortCode_Sh_Contact_Facts extends WPBakeryShortCodesContainer {
}
class WPBakeryShortCode_Sh_Contact_Fact extends WPBakeryShortCode {
}
