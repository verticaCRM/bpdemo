...
if(!class_exists('WPAlchemy_MetaBox1'))

{

	require_once SH_TH_ROOT.'includes/vp_new/classes/MetaBox.php';//VP_FileSystem::instance()->resolve_path('includes', 'wpalchemy/MetaBox');

}



class VP_MetaBox_Alchemy1 extends WPAlchemy_MetaBox1
