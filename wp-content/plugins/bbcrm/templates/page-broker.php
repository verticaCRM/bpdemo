...
<section id="content" class="container" style='margin-top:25px;'> 
...
?>
		...
		<div class="property_detail"><label><i style="color:#777;" class="fa fa-user"></i>&nbsp;<? _e('Name','bbcrm');?>:</label> <?php echo $broker->name; ?></div>		
		<div class="property_detail"><label><i style="color:#777;" class="fa fa-certificate"></i>&nbsp;<? _e('Title','bbcrm');?>:</label> <?php echo $broker->c_position; ?></div>		
		<div class="property_detail"><label><i style="color:#777;" class="fa fa-mobile-phone"></i>&nbsp;<? _e('Mobile Phone','bbcrm');?>:</label> <?php echo $broker->c_mobile; ?></div>		
		<div class="property_detail"><label><i style="color:#777;" class="fa fa-phone"></i>&nbsp;<? _e('Work Phone','bbcrm');?>:</label> <?php echo $broker->c_office; ?></div>		
<?php
	if($broker->c_hiredate){
?> 
		<div class="property_detail"><label><i style="color:#777;" class="fa fa-thumbs-o-up"></i>&nbsp;<? _e('Active Since','bbcrm');?>:</label> <?php echo date("F Y",$broker->c_hiredate); ?></div>
<?php } ?>


		<div class="property_detail"><label><i style="color:#777;" class="fa fa-globe"></i>&nbsp;Regions:</label> 
