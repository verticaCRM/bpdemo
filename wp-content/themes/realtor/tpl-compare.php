...
$meta = get_user_meta( $current_user->ID, '_ja_product_comparelist', true );//printr($meta);
								...
								<tbody>
									<tr>
										...
										<td class="wishlist_delete">
											<a class="remove" rel="product_del_compare" data-id="<?php echo esc_attr($met); ?>" href="javascript:;"><?php esc_html_e('Delete', SH_NAME); ?></a>
										</td>
									</tr>
								</tbody>
							<?php endforeach; ?>
