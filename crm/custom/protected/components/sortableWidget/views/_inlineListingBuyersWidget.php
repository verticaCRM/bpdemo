...
Yii::app()->clientScript->registerCssFile(
    Yii::app()->theme->baseUrl.'/css/components/sortableWidget/views/inlineListingBuyersWidget.css'
);
...
$columns = array(
    array(
        ...
        'value' => '(isset($data->relatedModel->Contacts->name))
            ? CHtml::link($data->relatedModel->Contacts->name,Yii::app()->createUrl("contacts",array($data->relatedModel->Contacts->id=>"")),array())
            : ""
            ',
...
$this->widget('X2GridViewGeneric', array(
    ...
    'gvSettingsName' => 'inlineListingBuyersGrid',
